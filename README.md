...
## Tính năng
- Layout gọn, responsive (mobile-first)
- 3 mục chính: Dịch vụ, Dự án, Bảng giá
...
## Tùy biến
- Đổi màu trong `styles.css` (biến `--primary`)
- Sửa nội dung trong `index.html` (dịch vụ, bảng giá, thông tin liên hệ)
- Ảnh demo trong thư mục `/assets`

## Lộ trình phát triển (Roadmap)
- [ ] Tích hợp gửi form qua email (Formspree)
- [ ] Thêm dark/light toggle
- [ ] Thêm trang blog (SEO)
